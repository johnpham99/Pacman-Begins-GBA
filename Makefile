...
# This should be a just a name i.e PacmanBegins
# No SPACES AFTER THE NAME.
PROGNAME = PacmanBegins
...
OFILES = gba.o font.o main.o images/titlescreen.o images/GreenHill.o images/Lose.o images/buzz.o
